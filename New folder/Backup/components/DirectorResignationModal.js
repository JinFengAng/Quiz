...
function DirectorResignationModal(props) {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${config.API_URL}/scripts/generate-director-resignation-forms`, data)
            .then(response => {
...
export default DirectorResignationModal
