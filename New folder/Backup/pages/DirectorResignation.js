...
import DirectorResignationModal from '../components/DirectorResignationModal'
import { Table } from 'antd';

function DirectorResignation() {
        ...
        },
        {
            ...
            render: (text) => <button className='rounded bg-blue-600 text-white py-1 px-4 hover:bg-blue-700'
                ...
                {shouldOpenDirectorResignationModal &&
                    <DirectorResignationModal setShouldOpenModal={setShouldOpenDirectorResignationModal}
    ...
    return (
        ...
        //             <tr >
        //                 <td className='border-gray-100 border-1 pl-2 pr-8 py-4'>Director Resignation</td>
...
export default DirectorResignation
