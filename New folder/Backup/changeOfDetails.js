...
function ChangeOfDetails() {
        ...
        },
        {
            ...
            render: (text) => <button className='rounded bg-blue-600 text-white py-1 px-4 hover:bg-blue-700'
                ...
                {shouldOpenDirectorResignationModal &&
                    <ChangeDetailsModal setShouldOpenModal={setShouldOpenDirectorResignationModal}
    ...
    const data = [
        {
            JobName: "Change Company's Name",
        },
        {
            JobName: "Change Business Activity",
        },
        {
            JobName: "Change Passport Number",
        },
    ];
    ...
    return (
        ...
        //             <tr >
        //                 <td className='border-gray-100 border-1 pl-2 pr-8 py-4'>Change Company's Name</td>
        ...
        //             <tr >
        //                 <td className='border-gray-100 border-1 pl-2 pr-8 py-4'>Change Business Activity</td>
        //                 <td className='border-gray-100 border-1 p-2'>
        //                     <button className='rounded bg-blue-600 text-white py-1 px-4 hover:bg-blue-700'
        //                         onClick={() => {
        //                             setShouldOpenDirectorResignationModal(true)
        ...
        //             <tr >
        //                 <td className='border-gray-100 border-1 pl-2 pr-8 py-4'>Change Passport Number</td>
        //                 <td className='border-gray-100 border-1 p-2'>
        //                     <button className='rounded bg-blue-600 text-white py-1 px-4 hover:bg-blue-700'
        //                         onClick={() => {
        //                             setShouldOpenDirectorResignationModal(true)
...
export default ChangeOfDetails
